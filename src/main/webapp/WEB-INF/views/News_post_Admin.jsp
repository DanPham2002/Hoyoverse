                    ...
                    <div class="header-container">
                        <header class="d-flex flex-wrap justify-content-center py-3 mb-4">
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item text-header">
                                    <a href="http://localhost:8080/news_admin" class="nav-link text-white"
                ...
                <div id="content">
                    <div class="container">
                        <div class="back-container">
                            <a href="http://localhost:8080/news_admin" class="btn-back">
                        ...
                        <!-- Update Bai viet -->
                        <div class="btn-edit"
                            style="position: fixed;display: flex;justify-content: center;align-items: center;bottom: 30%;right: 0; flex-direction: column;">
                            <a href="<c:url value='/editNews/' />${news.id}" class="edit-link"
                                style="text-decoration: none; text-align: center; font-weight: 550; ">Chỉnh sửa bài
                                viết</a>
                            ...
                            <a href="<c:url value='/deleteNews/' />${news.id}"
                                style="text-decoration: none; text-align: center; ">Xóa</a></td>
                            </a>
                        </div>
                ...
                <div class="footer-item">
                    <footer class="">
                        <ul class="nav justify-content-center pb-3 mb-3">
                            ...
                            <li class="nav-item"><a href="http://localhost:8080/news_admin"
